...
public class MemUtils {
    ...
    public static long getTotalPss(Context context, int pid){
        ...
        if (pid >= 0) {
            ...
            MemoryInfo[] memoryInfoArray = mAm.getProcessMemoryInfo(pids);
            MemoryInfo pidMemoryInfo = memoryInfoArray[0];
            value = pidMemoryInfo.getTotalPss();
        }
    ...
    public static long[] getHeapDalvik() {
        ...
        value_total[Total_HeapAlloc] = (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) >> 10;
        ...
        value_dalvik[Dalvik_HeapSize] = value_total[Total_HeapSize] - value_native[0];
        value_dalvik[Dalvik_HeapAlloc] = value_total[Total_HeapAlloc] - value_native[1];
