...
public class ProcessUtils {
    ...
    static class Process4x implements IProcess {
        ...
        public List<ProcessInfo> getAllRunningAppProcessInfo() {
            ActivityManager am = (ActivityManager) Config.getmContext().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        public boolean isProcessAlive(String sPid) {
            ...
            if (sPid != null && Config.getmContext() != null) {
                int pid = -1;
                try {
    ...
    static class Process5x implements IProcess
    {
        ...
        @Override
        public List<ProcessInfo> getAllRunningAppProcessInfo() {
            Log.d(Config.LOG_TAG,"通过Process5x获取进程信息");
        ...
        public boolean initUidPkgCache() {
            ...
            try {
                ...
                System.out.println("Root needed!");
            ...
            try {
                ...
                while((temp = br.readLine()) != null){
                    ...
                    if(tempArray.length > 2){
                        if(FormatUtils.isNumeric(tempArray[1])){
    ...
    static class Process6x extends Process5x
    {
        ...
        @Override
        public List<ProcessInfo> getAllRunningAppProcessInfo() {
            Log.d(Config.LOG_TAG,"通过Process6x获取进程信息");
            if (isLike5x)
            {
